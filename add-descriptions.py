...
def generate_yaml_description(file_save, file_name):
    if file_name.split("-")[0] == "suikogaiden":
        yaml.dump({'status': '#suikoden #suikogaiden #jrpg', 'spoiler_warning': '', 'description': 'Screenshot of Suikogaiden', 'language': '', 'sensitivity': ''}, file_save)
        ...
        yaml.dump({'status': '#suikoden #suikoden2 #jrpg', 'spoiler_warning': '', 'description': 'Screenshot of Suikoden II.', 'language': '', 'sensitivity': ''}, file_save)
        ...
        yaml.dump({'status': '#suikoden #suikoden4 #jrpg', 'spoiler_warning': '', 'description': 'Screenshot of Suikoden IV.', 'language': '', 'sensitivity': ''}, file_save)
    elif file_name.split("-")[1] == "05":
        yaml.dump({'status': '#suikoden #suikoden5 #jrpg', 'spoiler_warning': '', 'description': 'Screenshot of Suikoden V.', 'language': '', 'sensitivity': ''}, file_save)
        ...
        yaml.dump({'status': '#suikoden #SuikodenTsumuji #SuikodenTsumugareshiHyakunenNoToki #jrpg', 'spoiler_warning': '', 'description': 'Screenshot of Suikoden Tsumugareshi Hyakunen No Toki.', 'language': '', 'sensitivity': ''}, file_save)
